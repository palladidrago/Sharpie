...
import 'package:sharpie/screens/grades.dart';
...
Future<Name> _getName() async {
  //Returns list of grades.
  var mashovController = Controller();
  await mashovController.login(await getMashovUsername(),
      await getMashovPassword(), "540484", getMashovYear());
                ...
                Column(
                  ...
                  children: <Widget>[
                    FutureBuilder<Name>(
                      future: _name,
                      builder:
                          (BuildContext context, AsyncSnapshot<Name> snapshot) {
                        if (snapshot.hasData) {
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        routes: {'/grades': (context) => GradeList()});
  }
}
