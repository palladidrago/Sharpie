...
void mashovLoginSave(String username, String password,[ String semel = "540484", String year ]) async {
  ...
  if (now.month > 8/*August*/ ) realYear++; //The year needs to be current year plus one if it's after august.
  year = year ?? realYear.toString(); // year is the paramater if it's not null, is realYear if it is.
...
String getMashovUsername(){
  _sStorage.read(key:'mashovUsername');
} 
